...
// Resets
if ($props['icon'] && !($props['image'] || $props['video'] || $props['hover_image'] || $props['hover_video'])) { $element['panel_image_no_padding'] = ''; }
if ($element['panel_style'] || !($props['image'] || $props['video'] || $props['hover_image'] || $props['hover_video'])) {
...
if (!($element['panel_style'] || (!$element['panel_style'] && ($props['image'] || $props['video'] || $props['hover_image'] || $props['hover_video']) && $element['image_align'] != 'between'))) {
