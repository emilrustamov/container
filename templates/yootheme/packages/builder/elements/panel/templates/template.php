...
// Resets
if ($props['icon'] && !($props['image'] || $props['video'] || $props['hover_image'] || $props['hover_video'])) { $props['panel_image_no_padding'] = ''; }
if ($props['panel_style'] || !($props['image'] || $props['video'] || $props['hover_image'] || $props['hover_video'])) {
...
if (!($props['panel_style'] || (!$props['panel_style'] && ($props['image'] || $props['video'] || $props['hover_image'] || $props['hover_video']) && $props['image_align'] != 'between'))) {
    $props['panel_padding'] = '';
}
