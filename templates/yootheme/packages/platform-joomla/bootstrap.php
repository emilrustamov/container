...
return [
    ...
    'services' => array_merge(
        [
            ...
            CMSApplication::class => ['factory' => fn() => Factory::getApplication()],

            Container::class => ['factory' => fn() => Factory::getContainer()],

            Document::class => ['factory' => fn(CMSApplication $joomla) => $joomla->getDocument()],

            Input::class => ['factory' => fn(CMSApplication $joomla) => $joomla->input],

            Language::class => ['factory' => fn(CMSApplication $joomla) => $joomla->getLanguage()],

            Session::class => ['factory' => fn(CMSApplication $joomla) => $joomla->getSession()],

            SiteRouter::class => fn(Container $container) => $container->get(SiteRouter::class),

            User::class => ['factory' => fn(CMSApplication $joomla) => $joomla->getIdentity()],
        ],
