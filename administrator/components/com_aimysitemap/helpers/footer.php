 ...
 echo JUri::root() . '/media/com_aimysitemap/aimy-logo_100x50.png'; ?>" alt="Aimy Extensions Logo" width="100" height="50" /></a>
    ...
    <div class="span4">
        <p>
            ...
            <br/>
            <a href="<?php
 echo 'https://extensions.joomla.org/extensions/extension/', 'structure-a-navigation/site-map/aimy-sitemap'; echo '-pro'; ?>" target="_blank" rel="noopener"><strong>rate
                    us</strong></a>
            <br/>
    ...
    <div class="span4">
        ...
        <p>
            ...
            or
            <a href="https://aimy-extensions.com/images/products/sitemap/com-aimy-sitemap.pdf?r=33.1">Download the PDF Version</a>.
        </p>
    </div>
