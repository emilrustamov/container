...
<p>
<?php
 echo JText::sprintf( 'AIMY_SM_GOOGLE_XML_SITEMAP_PING_DISCONTINUATION_NOTE', 'https://www.aimy-extensions.com/news/aimy-sitemap/219-update-for-feature-notify-search-engines.html' ); ?>
</p>
<?php if ( $this->show_sitemap_field_hint ) : ?>
<p>
<?php
 echo JText::sprintf( 'AIMY_SM_ROBOTSTXT_SITEMAP_FIELD_MISSING_HINT', JRoute::_( 'index.php?option=com_aimysitemap&view=robotstxt' ) ); ?>
</p>
<?php endif; ?>
</div>
...
<p>
<?php
 echo JText::sprintf( 'AIMY_SM_INDEXNOW_BING_YANDEX_NOTE', 'https://www.aimy-extensions.com/joomla/indexnow.html', 'https://www.aimy-extensions.com/how-to-use-xml-sitemap-and-indexnow-together.html' ); ?>
</p>
</div>
