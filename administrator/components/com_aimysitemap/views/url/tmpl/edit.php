 ...
 */
 defined( '_JEXEC' ) or die(); require_once( JPATH_COMPONENT . '/helpers/compat.php' ); $fields = array( 'id', 'title', 'url', 'priority', 'changefreq', 'lang', 'state', 'lock', 'mtime' ); try { JHtml::_( version_compare( JVERSION, '3.3.0', 'lt' ) ? 'behavior.framework' : 'behavior.core' ); JHtml::_( version_compare( JVERSION, '3.4.0', 'lt' ) ? 'behavior.formvalidation' : 'behavior.formvalidator' ); if ( AimySitemapCompatHelper::isJoomla3() ) { JHtml::_( 'formbehavior.chosen', 'select' ); } } catch ( Exception $e ) { } ?>
