    ...
    <div id="j-main-container">
        ...
        <?php if (!NRFramework\Functions::getDownloadKey()) { ?>
            <div class="alert alert-danger alert-info">
                ...
                <?php echo JText::sprintf("COM_CONVERTFORMS_ADDONS_MISSING_KEY"); ?>

                <a style="position:relative; top:-2px; left:5px;" class="btn btn-small btn-sm btn-success" href="<?php echo JURI::base() ?>index.php?option=com_plugins&view=plugins&filter_search=novarain">
